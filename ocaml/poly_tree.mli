(* $Id: poly_tree.mli,v 1.1 2013-03-28 15:34:33 deraugla Exp $ *)
...
value tree_pow_list_y : field C.t → tree C.t → list (tree C.t * int);
value const_pow_list_x : field C.t → tree C.t → list (C.t * Q.t);
