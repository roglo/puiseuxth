(* $Id: Field.v,v 2.12 2013-11-20 19:49:55 deraugla Exp $ *)
...
Lemma fld_mul_add_distr_r : ∀ α (fld : field α) x y z,
 fld_eq fld (mul fld (add fld x y) z) (add fld (mul fld x z) (mul fld y z)).
Proof.
intros a fld x y z.
...
Definition machin α (fld : field α) :=
  {| Radd_0_l := fld_add_0_l fld;
     ...
     Rdistr_l := fld_mul_add_distr_r fld;
